                    ...
                    <tr>
                        ...
                        <td>
                            <div class="radio checkbox-inline">
                                <input type="radio" name="status2" value="0" id="radio-4"><label class="mar_r20" for="radio-4">NEW</label>
                            </div>
                            <div class="radio checkbox-inline">
                                <input type="radio" name="status2" value="1" id="radio-5"><label class="mar_r20" for="radio-5">Hot</label>
                            </div>
                            <div class="radio checkbox-inline">
                                <input type="radio" name="status2" value="2" id="radio-6"><label class="mar_r20" for="radio-6">Trending</label>
                            </div>

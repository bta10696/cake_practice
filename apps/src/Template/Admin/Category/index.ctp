	...
	<div class="box">
		...
		<div class="table_area">
			<table class="table__list" style="table-layout: fixed;">
				<colgroup>
					<?= $has_status ? '<col style="width: 150px;">' : "" ?>
					<col>
				...
				<tr>
					...
					<th style="text-align: center;">総量商品</th>
                ...
                <?php foreach ($datas as $key => $data) : ?>
                    ...
                    <tr class="<?= $tr_class ?>" id="content-<?= $data->id ?>">
                        ...
                        <td><?= $this->Html->link(html_decode($data->category_name), ['action' => 'edit', $data->id]); ?></td>
                        <td></td>
